...
var doces = [
    new Doce('Pirulito',
        'https://www.buildabirthday.co.nz/cdn/shop/files/RAINBOWJUMBO.jpg?v=1715031535', 2.50, 'Bala'),
    new Doce('Sonho de Valsa',
        'https://images.tcdn.com.br/img/img_prod/1225570/sonho_de_valsa_20g_unidade_1677_1_79762930ee3ce201b3e1f8574cf0ba1a.png', 5.99, 'Bombom'),
    new Doce('Talento',
        'https://destro.fbitsstatic.net/img/p/chocolate-talento-avelas-85g-80676/267231.jpg', 10.50, 'Chocolate'),
    new Doce('Kit Kat',
        'https://placehold.co/300x200/1a2744/ffffff?text=Kit+Kat', 7.00, 'Chocolate'),
    new Doce('Bis',
        'https://placehold.co/300x200/2d5a27/ffffff?text=Bis', 3.50, 'Chocolate'),
    new Doce('Paçoca',
        'https://placehold.co/300x200/ca6f1e/ffffff?text=Pacoca', 1.50, 'Bala'),
];
